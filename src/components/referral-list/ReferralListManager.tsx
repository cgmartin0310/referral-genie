...
/**
 * Every practice on the subscriber's clinic referral lists, to score (its tier
 * sets the outreach; Not a fit is never faxed), with adding missing practices
 * and uploading a list. Your Sources, and the scoring step of onboarding.
 */
export default function ReferralListManager({ heading = true }: { heading?: boolean }) {
  ...
  return (
    <div>
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          {heading && <h1 className="text-2xl font-semibold tracking-tight text-gray-900">Your Sources</h1>}
          <p className={classNames('max-w-3xl text-sm text-gray-600', heading && 'mt-1')}>
