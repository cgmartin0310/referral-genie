...
/** Navy sidebar, white workspace. */
const SIDEBAR = 'bg-[#0B2A5B]';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:pl-64">
        <div className="sticky top-0 z-40 flex h-14 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 sm:px-6 lg:hidden">
